...
use super::types::{
    KimiCommonConfig, KimiPromptConfig, KimiPromptConfigContent, KimiProvider, KimiProviderContent,
};
use crate::coding::db_id::db_extract_id;

pub fn provider_from_db_value(value: Value) -> KimiProvider {
    KimiProvider {
...
pub fn provider_to_db_value(content: &KimiProviderContent) -> Value {
...
pub fn common_from_db_value(value: Value) -> KimiCommonConfig {
    KimiCommonConfig {
        config: value
            .get("config")
            .and_then(Value::as_str)
...
pub fn prompt_from_db_value(value: Value) -> KimiPromptConfig {
    KimiPromptConfig {
        id: db_extract_id(&value),
        name: string_field(&value, "name"),
...
pub fn prompt_to_db_value(content: &KimiPromptConfigContent) -> Value {
